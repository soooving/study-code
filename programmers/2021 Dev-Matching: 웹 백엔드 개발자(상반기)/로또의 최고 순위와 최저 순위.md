<div class="modal-content">
    <div class="modal-header">
      <h3 class="modal-title">로또의 최고 순위와 최저 순위</h3>
    </div>      
    <div class="modal-body">      
      <div id="algo-description">
        <div class="markdown github"><p><code>로또 6/45</code>(이하 '로또'로 표기)는 1부터 45까지의 숫자 중 6개를 찍어서 맞히는 대표적인 복권입니다. 아래는 로또의 순위를 정하는 방식입니다. <sup id="fnref1"><a href="#fn1">1</a></sup></p>
<table class="table">
        <thead><tr>
<th>순위</th>
<th>당첨 내용</th>
